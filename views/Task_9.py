...
with math_tab:
    ...
    Then, using the Verlet method (see task 8), we can model the approximate path of the projectile by assuming the accerlation is constant between small discrete time steps, $\Delta t$. 
    """
